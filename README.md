...
A [wofi](https://hg.sr.ht/~scoopta/wofi)-based profile launcher inspired by
[rofirefox](https://github.com/ethmtrgt/rofirefox). It's compatible with any
...
Then, enable the package by adding `wofizilla.packages.x86_64-linux.wozilla` to
